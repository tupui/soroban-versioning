...
Tansu's goal is to provide a way to validate projects with on-chain data. This can only work if Tansu's contract is actually what you think it is. This is why we happy to share that we added support for [stellar.expert](https://stellar.expert/explorer/public)'s contract validation mechanism.
