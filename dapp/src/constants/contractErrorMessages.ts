...
export const contractErrorMessages = {
  ...
  10: "Voting is not allowed at this time.",
  11: "The proposal is no longer active.",
  12: "The voting type is wrong.",
  13: "You are an invalid voter.",
  14: "There is a tally seed error.",
  15: "The proof is invalid.",
  16: "Anonymous voting is not configured for this project.",
  17: "Bad commitment.",
