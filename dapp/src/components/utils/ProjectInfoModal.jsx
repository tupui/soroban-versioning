        ...
        {projectInfo && Object.keys(projectInfo).length > 0 ? (
          ...
          <div className="space-y-4">
            ...
            <div className="h-40 flex items-center px-4 sm:px-8 pb-4">
              <p className="text-lg text-center">This project is missing a <a href='https://tansu.dev/docs/project_information_file' target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">tansu.toml</a> configuration file.</p>
            </div>
