          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-6">
              ...
              <img
                ...
                className="w-64 sm:w-[40%] object-cover rounded-lg"
              />
              <div className="flex-1 pt-2 w-full">
                <p id="project-description" className="flex-1">
                      ...
                      ([platform, link]) =>
                        link && (
                          <a
                            ...
                            className="flex items-center space-x-1 bg-zinc-200 hover:bg-zinc-300 rounded-lg px-3 py-1 text-sm"
                          >
