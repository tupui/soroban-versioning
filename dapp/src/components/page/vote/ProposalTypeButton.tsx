...
const ProposalTypeButton: React.FC<ProposalTypeButtonProps> = ({
  ...
  const buttonClass = `px-2.5 sm:px-3 py-1.5 sm:py-2 text-md sm:text-xl font-medium border border-[#CBCBCB] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white ${
    isSelected ? "bg-[#CBCBCB]" : "bg-white"
