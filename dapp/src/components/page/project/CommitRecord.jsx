...
import { formatTime } from "@utils/formatTimeFunctions.ts";
      ...
      <div className="commit-info flex-grow overflow-hidden mr-4">
        <div className="flex items-center">
          <a
            ...
            className="commit-message text-lg font-medium hover:underline hover:text-blue-500 truncate"
          >
            {firstLine}
          </a>
          {hasMoreLines && (
            <button
              ...
              className="expand-button ml-2 text-xs bg-zinc-200 hover:bg-zinc-300 text-gray-700 font-semibold py-1 px-2 rounded-md transition-colors duration-200 flex-shrink-0"
            >
              {isExpanded ? "Less" : ". . ."}
            </button>
          )}
        ...
        {hasMoreLines && isExpanded && (
          <div className="expanded-message mt-2 text-sm text-gray-700 whitespace-pre-wrap">
        ...
        <div className="commit-details text-sm text-gray-600 mt-1">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="author-name font-semibold hover:underline hover:text-blue-500"
          >
            {authorName}
          </a>
      ...
      <div className="commit-sha flex items-center space-x-2 flex-shrink-0">
        <div className="relative group">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="sha text-sm font-mono text-gray-500 hover:bg-zinc-400 transition-colors duration-200 px-2 py-1 rounded"
          >
            {sha.substring(0, 7)}
          </a>
