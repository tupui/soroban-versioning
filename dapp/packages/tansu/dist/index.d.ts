...
import type { u32, u64, u128, AssembledTransactionOptions, Option } from "@stellar/stellar-sdk/contract";
...
export interface Client {
    ...
    proof: ({ project_key, proposal, tallies, seeds, }: {
        ...
        tallies: Array<u128>;
        seeds: Array<u128>;
    }, options?: AssembledTransactionOptions<boolean>) => Promise<AssembledTransaction<boolean>>;
    /**
    ...
    }, options?: AssembledTransactionOptions<ProposalStatus>) => Promise<AssembledTransaction<ProposalStatus>>;
    /**
    ...
    get_dao: ({ project_key, page }: {
        project_key: Buffer;
        page: u32;
    }, options?: AssembledTransactionOptions<Dao>) => Promise<AssembledTransaction<Dao>>;
    /**
    ...
    get_proposal: ({ project_key, proposal_id }: {
        project_key: Buffer;
        proposal_id: u32;
    }, options?: AssembledTransactionOptions<Proposal>) => Promise<AssembledTransaction<Proposal>>;
    /**
     ...
     */
    create_proposal: ({ proposer, project_key, title, ipfs, voting_ends_at, public_voting, outcomes_contract, }: {
        proposer: string;
        project_key: Buffer;
        title: string;
        ipfs: string;
    ...
    get_anonymous_voting_config: ({ project_key }: {
        project_key: Buffer;
    }, options?: AssembledTransactionOptions<AnonymousVoteConfig>) => Promise<AssembledTransaction<AnonymousVoteConfig>>;
    /**
    ...
    build_commitments_from_votes: ({ project_key, votes, seeds, }: {
        ...
        votes: Array<u128>;
        seeds: Array<u128>;
    }, options?: AssembledTransactionOptions<Array<Buffer>>) => Promise<AssembledTransaction<Array<Buffer>>>;
    /**
     ...
     */
    version: (options?: AssembledTransactionOptions<u32>) => Promise<AssembledTransaction<u32>>;
    /**
     ...
     */
    get_admins_config: (options?: AssembledTransactionOptions<AdminsConfig>) => Promise<AssembledTransaction<AdminsConfig>>;
    /**
     ...
     */
    require_not_paused: (options?: AssembledTransactionOptions<null>) => Promise<AssembledTransaction<null>>;
    /**
     ...
     */
    get_upgrade_proposal: (options?: AssembledTransactionOptions<UpgradeProposal>) => Promise<AssembledTransaction<UpgradeProposal>>;
    /**
     ...
     */
    add_member: ({ member_address, meta, git_identity, git_pubkey, msg, sig, }: {
    ...
    get_badges: ({ key }: {
        key: Buffer;
    }, options?: AssembledTransactionOptions<Badges>) => Promise<AssembledTransaction<Badges>>;
    /**
    ...
    get_member: ({ member_address }: {
        member_address: string;
    }, options?: AssembledTransactionOptions<Member>) => Promise<AssembledTransaction<Member>>;
    /**
    ...
    register: ({ maintainer, name, maintainers, url, ipfs, }: {
        ...
        url: string;
        ipfs: string;
    }, options?: AssembledTransactionOptions<Buffer>) => Promise<AssembledTransaction<Buffer>>;
    /**
    ...
    get_project: ({ project_key }: {
        project_key: Buffer;
    }, options?: AssembledTransactionOptions<Project>) => Promise<AssembledTransaction<Project>>;
    /**
    ...
    get_projects: ({ page }: {
        page: u32;
    }, options?: AssembledTransactionOptions<Array<Project>>) => Promise<AssembledTransaction<Array<Project>>>;
    /**
