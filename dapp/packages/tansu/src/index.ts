...
export const ContractErrors = {
  ...
  202: { message: "ProposalInputValidation" },
  203: { message: "UnknownMember" },
  204: { message: "MemberAlreadyExist" },
  205: { message: "InvalidDomainError" },
  206: { message: "WrongVoteType" },
  207: { message: "BadCommitment" },
  208: { message: "VoterWeight" },
  209: { message: "VoteLimitExceeded" },
...
export interface Client {
   ...
   * * [`Option<Vec<OutcomeContract>>`] - Optional outcome contracts executed after proposal completion
   *
   * # Returns
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        ...
        "",
        ...
        "",
