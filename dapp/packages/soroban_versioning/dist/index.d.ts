...
export interface Client {
     ...
     */
    create_proposal: ({ proposer, project_key, title, ipfs, voting_ends_at }: {
        proposer: string;
        project_key: Buffer;
        title: string;
        ipfs: string;
     ...
     */
    register: ({ maintainer, name, maintainers, url, hash, domain_contract_id }: {
        maintainer: string;
        name: string;
        maintainers: Array<string>;
        url: string;
     ...
     */
    update_config: ({ maintainer, key, maintainers, url, hash }: {
        maintainer: string;
        key: Buffer;
        maintainers: Array<string>;
        url: string;
